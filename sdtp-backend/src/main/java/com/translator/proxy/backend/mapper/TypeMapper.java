 ...
 *
 * <p>
 * 用于生成 ColumnDefinition41 包中的 columnType 字段。 未覆盖的类型默认映射为 FIELD_TYPE_VAR_STRING (0xFD)。
 */
public final class TypeMapper {
    ...
    /**
     * 根据 JDBC Types 推断显示的列长度（用于 ColumnDefinition41.length）。 这是一个粗略估算，实际使用中影响不大。
     */
